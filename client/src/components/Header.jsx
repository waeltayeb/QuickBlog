    ...
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className='text-center mt-20 mb-8'> 
            ...
            <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>
                this is your space to think out loud, ro share what matters, and to write without filter. whether it's one word or a thousand, your story dtarts right here.
            </p>
        ...
        <div className='text-center mt-4'>
            {
                input && <button onClick={onClear} className='text-xs py-1 px-3 rounded-sm border font-light text-gray-500 hover:text-gray-700 cursor-pointer'>Clear Search</button>
            }
        </div>
